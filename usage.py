...
def display_output(
    row, multiRowsClicked, cellClicked, cellEdited, dataChanged, filters, dataFiltered
):
    print("row: {}".format(str(row)))
    print("cellClicked: {}".format(str(cellClicked)))
    print("cellEdited: {}".format(str(cellEdited)))
    print("data changed: {}".format(str(dataChanged)))
    print("filters: {}".format(str(filters)))
    print("data filtered: {}".format(str(dataFiltered)))
    return "You have clicked row {} ; cell {} ; multiRowsClicked {}".format(
        row, cellClicked, multiRowsClicked
    )
